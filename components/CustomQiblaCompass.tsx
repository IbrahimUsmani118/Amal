...
interface CustomQiblaCompassProps {
      ...
      try {
        ...
        subscription = Magnetometer.addListener((data) => {
          ...
          Animated.timing(compassRotationAnim, {
            ...
            duration: 50, // Even faster animation for responsiveness
    ...
    <View style={[styles.container, { backgroundColor }]}>
      ...
      <View style={styles.compassRing}>
        ...
        <View style={styles.calibrationContainer}>
          ...
          <Text style={[styles.calibrationText, { color: textColor, fontSize: 10, marginTop: 5 }]}>
      ...
      <View style={styles.directionInfo}>
        ...
        <Text style={[styles.directionText, { color: textColor, fontSize: 16 }]}>
